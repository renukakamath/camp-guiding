...
//		url = sh.getString("url", "");
		...
		b1.setOnClickListener(new View.OnClickListener() 
		{
			public void onClick(View arg0)
			{
				...
				else
				{
			        ...
			        String q = "/chat?sender_id="+sh.getString("log_id", "")+"&receiver_id="+viewphotograph.lid+"&details="+chat;
			        q=q.replace(" ","%20");
			        JR.execute(q);
	...
	void getChats() {
			...
			JsonReq JR=new JsonReq();
	        JR.json_response=(JsonResponse) ChatHere.this;
	        String q = "/chatdetail?sender_id="+sh.getString("log_id", "")+"&receiver_id="+viewphotograph.lid;
	        q=q.replace(" ","%20");
...
//					 val=new String[ja1.length()];
					...
					{ 
						...
						message[i]=ja1.getJSONObject(i).getString("msg");
