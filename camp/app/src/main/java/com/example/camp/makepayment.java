        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                else if(cvv.equalsIgnoreCase("")|| cvv.length()!=3)
                {
                    ...
                    String q = "/Makepayment?login_id=" + sh.getString("log_id", "")+ "&amount=" +viewproposal.amt +"&name="+ name +"&pid=" +viewproposal.pid +"&bid=" +viewproposal.bid;
                    q = q.replace(" ", "%20");
                    JR.execute(q);
                }
